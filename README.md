...
一个基于微信小程序原生技术栈开发的深圳英语背单词 MVP 项目，面向 1-12 年级学生，提供背词学习、词库浏览、自动听写、拼字游戏、虚拟宠物成长和本地多账号能力。

## 项目简介

`WordMaster SZ` 是一个已经跑通 MVP 的背单词小程序，目标是用轻量、低门槛、可持续迭代的方式，帮助小学和中学生进行英语词汇记忆与复习。
